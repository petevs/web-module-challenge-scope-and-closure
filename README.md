...
Closure is when inner variables reference outer variables.
...
The closure is in the nested function. It references name.

b. Compare and contrast calling `dansRoll` the first and second time.

What is always the same? What could change?

The name is always the same, the newRoll could change each time the function is run.
